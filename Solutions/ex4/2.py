...
my_parser = argparse.ArgumentParser(
    description="Simple solution for ex4.", epilog="Enjoy the program! :)"
)
...
# flags
my_parser.add_argument("-v", "--verbose", action="store_true", help="flag v")

my_parser.add_argument("-d", action="store_true", help="flag d")

my_parser.add_argument("-e", action="store_true", help="flag e")
